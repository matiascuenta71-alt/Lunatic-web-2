...
export default function SponsorView() {
  ...
  return (
    <div id="sponsor-nervox-view" className="space-y-8 max-w-6xl mx-auto py-4">
      ...
      <div className="relative rounded-[24px] bg-[#090909] border border-red-500/20 p-6 md:p-10 shadow-[0_0_50px_rgba(255,45,45,0.06)] overflow-hidden">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          {/* LADO IZQUIERDO: Logo de Nervox Hosting (3Cols/12) */}
          ...
          {/* LADO DERECHO: Detalles & Acciones (8Cols/12) */}
        ...
        {/* SECCIÓN INFERIOR: BOTONES DE ACCIÓN DIRECTA EN NUEVA PESTAÑA */}
